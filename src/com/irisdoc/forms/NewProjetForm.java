...
public class NewProjetForm extends GenericForm {
	...
	public NewProjetForm(ProjetDAO projetDAO) {
		this.projetDAO = projetDAO;
	}
	
	public void newProjet(HttpServletRequest request) {
